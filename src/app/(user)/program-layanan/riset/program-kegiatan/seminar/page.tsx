...
export default function SeminarListPage() {
  ...
  const { data, isLoading, isError } = useGetData<SeminarListResponse>({
    key: ["list-seminar", JSON.stringify(apiParams)],
    url: "/seminar",
    params: apiParams,
  });
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {!isLoading && !isError && items.length === 0 && (
            <div className="col-span-full text-center py-20 text-gray-500 bg-white rounded-xl border border-gray-100">
              Tidak ada seminar yang ditemukan.
            </div>
          )}
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <div className="mt-auto pt-4 border-t border-gray-50">
                  <Link
                    href={`/program-layanan/riset/program-kegiatan/seminar/${item.id}`}
