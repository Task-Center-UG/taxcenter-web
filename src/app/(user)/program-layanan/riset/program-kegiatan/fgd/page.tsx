...
export default function FgdListPage() {
  ...
  const { data, isLoading, isError } = useGetData<FgdListResponse>({
    key: ["list-fgd", JSON.stringify(apiParams)],
    url: "/fgd",
    params: apiParams,
  });
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <div className="mt-auto pt-4 border-t border-gray-50">
                  <Link
                    href={`/program-layanan/riset/program-kegiatan/fgd/${item.id}`}
